...
//		documento.setNomeArquivo("OF-599-2016-DIDES-33902438169201608-16513178000176-ABI.pdf");
...
//		File file = new File(classLoader.getResource("OF-599-2016-DIDES-33902438169201608-16513178000176-ABI.pdf").getFile());
