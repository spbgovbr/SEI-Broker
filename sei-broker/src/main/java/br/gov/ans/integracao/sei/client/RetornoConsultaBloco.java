...
public class RetornoConsultaBloco implements java.io.Serializable {
	 ...
	 */
	public void setUnidadesDisponibilizacao(
			br.gov.ans.integracao.sei.client.Unidade[] unidadesDisponibilizacao) {
		this.unidadesDisponibilizacao = unidadesDisponibilizacao;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& ((this.unidade == null && other.getUnidade() == null) || (this.unidade != null && this.unidade
						.equals(other.getUnidade())))
				&& ((this.usuario == null && other.getUsuario() == null) || (this.usuario != null && this.usuario
				...
				&& ((this.estado == null && other.getEstado() == null) || (this.estado != null && this.estado
						.equals(other.getEstado())))
				&& ((this.unidadesDisponibilizacao == null && other
						.getUnidadesDisponibilizacao() == null) || (this.unidadesDisponibilizacao != null && java.util.Arrays
						.equals(this.unidadesDisponibilizacao,
								other.getUnidadesDisponibilizacao())))
				&& ((this.protocolos == null && other.getProtocolos() == null) || (this.protocolos != null && java.util.Arrays
						.equals(this.protocolos, other.getProtocolos())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getUnidadesDisponibilizacao() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getUnidadesDisponibilizacao()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getUnidadesDisponibilizacao(), i);
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			RetornoConsultaBloco.class, true);
