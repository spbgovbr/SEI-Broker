...
public class InfoResource {
	 ...
	 * 	
	 * @apiExample {curl} Exemplo de requisição:
	 * 	curl -i http://anshmjboss01/sei-broker/service/info/conexoes/mysql
	 *
	 ...
	 * 	
	 * @apiExample {curl} Exemplo de requisição:
	 * 	curl -i http://anshmjboss01/sei-broker/service/info/conexoes/oracle
	 *
	 ...
	 * 	
	 * @apiExample {curl} Exemplo de requisição:
	 * 	curl -i http://anshmjboss01/sei-broker/service/info
	 *
	...
	@Path("/requests")
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public List<LogIntegracaoSistemica> getUltimosRequests(@QueryParam("qtdRegistros") String qtdRegistros) throws BusinessException{
		Query query = dao.createNamedQuery("LogIntegracaoSistemica.ultimosRequests", null);
		
		query.setMaxResults(qtdRegistros == null ? Constantes.TAMANHO_PAGINA_PADRAO : parseInt(qtdRegistros));			
	...
	public String getInfoHTML() throws Exception{
		...
		List<LogIntegracaoSistemica> requests = getUltimosRequests("10");
