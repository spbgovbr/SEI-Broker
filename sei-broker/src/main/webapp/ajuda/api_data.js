define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "template",
            "description": "<p>Template que será utilizado na transformação do conteudo para HTML, o template precisa ser previamente cadastrado. (Este atributo exige que o atributo conteudo seja enviado em formato JSon)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "conteudo",
            "description": "<p>Conteúdo do arquivo codificado em Base64. Para documentos gerados será o conteúdo da seção principal do editor HTML e para documentos externos será o conteúdo do anexo. Para documentos com template cadastrado, enviar o JSon referente ao conteúdo a ser preenchido no template.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    ...
    "url": "",
    "version": "0.0.0",
    "filename": "barramento-sei/target/sei-broker-1.2/ajuda/main.js",
    "group": "c__ANS_ARQUITETURA_Fontes_Barramento_SEI_trunk_barramento_sei_target_sei_broker_1_2_ajuda_main_js",
    "groupTitle": "c__ANS_ARQUITETURA_Fontes_Barramento_SEI_trunk_barramento_sei_target_sei_broker_1_2_ajuda_main_js",
    "name": ""
  }
] });
