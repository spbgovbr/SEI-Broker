define({ "api": [
  ...
  },
  {
    ...
    "url": "",
    "version": "0.0.0",
    "filename": "sei-broker/src/main/webapp/ajuda/main.js",
    "group": "C__ANS_sei_broker_branches_desenvolvimento_andre_sei_broker_src_main_webapp_ajuda_main_js",
    "groupTitle": "C__ANS_sei_broker_branches_desenvolvimento_andre_sei_broker_src_main_webapp_ajuda_main_js",
    "name": ""
  },
  {
    "success": {
    ...
    "url": "",
    "version": "0.0.0",
    "filename": "sei-broker/target/sei-broker-1.3.1/ajuda/main.js",
    "group": "C__ANS_sei_broker_branches_desenvolvimento_andre_sei_broker_target_sei_broker_1_3_1_ajuda_main_js",
    "groupTitle": "C__ANS_sei_broker_branches_desenvolvimento_andre_sei_broker_target_sei_broker_1_3_1_ajuda_main_js",
    "name": ""
  },
  {
    "type": "post",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Exemplo de requisição:\t",
        "content": "curl -i http://anshmjboss01/sei-broker/service/363022/documentos",
        "type": "json"
      }
    ],
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "description": "<p>ATENÇÃO: este atributo está no header HTTP da resposta e representa a quantidade de registros que existem para essa consulta</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Exemplo de requisição:\t",
        "content": "curl -i http://anshmjboss01/sei-broker/service/COSAP/documentos/enviados-broker?pagina=1&qtdRegsitros=30",
        "type": "json"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "group": "Documento",
    "version": "0.0.1",
    "description": "<p>Realiza a inclusão de um documento.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": true,
            "field": "template",
            "description": "<p>Nome do template que será utilizado na transformação do conteudo para HTML, o template precisa ser previamente cadastrado no repositório do SEI-Broker. (Este atributo exige que o atributo conteudo seja enviado em formato JSon) [QUERY PARAMETER]</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Exemplo de requisição:",
        "content": "curl -i http://anshmjboss01/sei-broker/service/info",
        "type": "curl"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Exemplo de requisição:",
        "content": "curl -i http://anshmjboss01/sei-broker/service/info/versao",
        "type": "curl"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Exemplo de requisição:",
        "content": "curl -i http://anshmjboss01/sei-broker/service/info/conexoes/mysql",
        "type": "curl"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Exemplo de requisição:",
        "content": "curl -i http://anshmjboss01/sei-broker/service/info/conexoes/oracle",
        "type": "curl"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Exemplo de requisição:\t",
        "content": "curl -i http://anshmjboss01/sei-broker/service/414247/processos",
        "type": "json"
      }
    ],
    "success": {
