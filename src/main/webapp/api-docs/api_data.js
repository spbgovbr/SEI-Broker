define({ "api": [
      ...
      "fields": {
        ...
        "Request Body": [
          ...
          },
          {
            ...
            "description": "<p>Conteúdo total ou parcial codificado em Base64.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        ...
        "Request Body": [
          ...
          },
          {
            ...
            "description": "<p>Conteúdo parcial codificado em Base64.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "url": "",
    "version": "0.0.0",
    "filename": "sei-broker/target/sei-broker-2.0/api-docs/main.js",
    "group": "C__ANS_sei_broker_branches_desenvolvimento_versao_3_sei_broker_target_sei_broker_2_0_api_docs_main_js",
    "groupTitle": "C__ANS_sei_broker_branches_desenvolvimento_versao_3_sei_broker_target_sei_broker_2_0_api_docs_main_js",
    "name": ""
  },
  {
    "type": "get",
  ...
  },
  {
    ...
    "group": "Documento",
    "version": "1.0.0",
    "description": "<p>Inclui um documento no SEI.</p>",
    "parameter": {
      "fields": {
        "Path Parameters": [
          {
        ...
        "Query Parameters": [
          {
            ...
            "optional": true,
            "field": "template",
            "description": "<p>Nome do template que será utilizado na transformação do conteudo para HTML, o template precisa ser previamente cadastrado no repositório do SEI-Broker. (Este atributo exige que o atributo conteudo seja enviado em formato JSon e codificado em Base64)</p>"
          }
        ],
        "Request Body": [
          {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Exemplo de requisição:",
        "content": "curl -i http://<host>/sei-broker/service/COSAP/hipoteses-legais",
        "type": "json"
      }
    ],
    "success": {
