 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {siglaSistema, identificacaoServico, idUnidade, documento});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                ...
                return (br.gov.ans.integracao.sei.client.RetornoInclusaoDocumento) org.apache.axis.utils.JavaUtils.convert(_resp, br.gov.ans.integracao.sei.client.RetornoInclusaoDocumento.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
