...
public class ProcessoResource {
	...
	@GET
	@Path("/{unidade}/processos/{processo}/andamentos")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	...
	@Path("/{unidade}/processos/{processo}/andamentos")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	public Andamento lancarAndamento(@PathParam("unidade") String unidade, @PathParam("processo") String processo, NovoAndamento andamento) throws RemoteException, Exception{
		
		return seiNativeService.lancarAndamento(Constantes.SEI_BROKER, Operacao.LANCAR_ANDAMENTO, unidadeResource.consultarCodigo(unidade), formatarNumeroProcesso(processo)
				, andamento.getTarefa(), andamento.getTarefaModulo(), buildAtributosAndamento(andamento.getAtributos()));		
	}	
	
	@GET
	@Path("/{unidade}/processos/{processo}/anexados")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	...
	@DELETE
	@Path("/{unidade}/processos/{processo}/anexados/{processoAnexado}")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	...
	@POST
	@Path("/{unidade}/processos/{processo}/bloqueados")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	public Response bloquearProcesso(@PathParam("unidade") String unidade, @PathParam("processo") String processo) throws RemoteException, Exception{

		String retorno = seiNativeService.bloquearProcesso(Constantes.SEI_BROKER, Operacao.BLOQUEAR_PROCESSO, unidadeResource.consultarCodigo(unidade), formatarNumeroProcesso(processo));
	...
	@POST
	@Path("/{unidade}/processos/{processo}/relacionados")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	...
	@DELETE
	@Path("/{unidade}/processos/{processo}/relacionados/{processoRelacionado}")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	...
	@POST
	@Path("/{unidade}/processos/{processo}/sobrestados")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	public Response sobrestarProcesso(@PathParam("unidade") String unidade, @PathParam("processo") String processo, SobrestamentoProcesso motivo) throws RemoteException, Exception{

		String retorno = seiNativeService.sobrestarProcesso(Constantes.SEI_BROKER, Operacao.SOBRESTAR_PROCESSO, unidadeResource.consultarCodigo(unidade), formatarNumeroProcesso(processo), 
				formatarNumeroProcesso(motivo.getProcessoVinculado()), motivo.getMotivo());
