...
public class DocumentoResource {
	 ...
	 * @apiParam (Path Parameters) {String} unidade Sigla da Unidade cadastrada no SEI
	 * 
	 * @apiParam (Query Parameters) {String} [template] Nome do template que será utilizado na transformação do conteudo para HTML, o template precisa ser previamente cadastrado no repositório do SEI-Broker. (Este atributo exige que o atributo conteudo seja enviado em formato JSon e codificado em Base64)
	 * 
