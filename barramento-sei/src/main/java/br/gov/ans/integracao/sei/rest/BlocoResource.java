...
public class BlocoResource {
	...
	public String gerarBloco(@PathParam("unidade") String unidade, NovoBloco bloco) throws Exception{
		return seiNativeService.gerarBloco(Constantes.SEI_BROKER, Operacao.GERAR_BLOCO, unidadeResource.consultarCodigo(unidade), bloco.getTipo().getCodigo(), bloco.getDescricao(), bloco.getUnidades(), 
	 ...
	 */
	@DELETE
	@Path("/{bloco}/documentos/{documento}")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
